    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                txtResultValue.setText(calculate(distance, price, consumption, people, tolls));
            }
        });

    }

    private String calculate(Float distance, Float price, Float consumption, Integer people, Float tolls) {
        Float gas  = (distance * consumption)/100;
        Float cost = (gas * price) + tolls;
        return round(cost / people) + getResources().getString(R.string.cur_symbol);
    }
